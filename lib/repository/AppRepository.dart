...
class AppRepository {
  ...
  Future<List<CreditCard>> getCreditCardsByType(String id) =>
      cardaccess.getCreditCardsByType(id);
  Future deleteCardByCardType(int id) => cardaccess.deleteCreditCardByType(id);
  Future deleteAllCreditCardsByTypes(int id) =>
      cardaccess.deleteAllCreditCardsByTypes(id);
  // ! useraccess
  ...
  Future updateLog(Log log) => logaccess.updateLog(log);
  ...
  Future addTypesIfNotExist() => typeaccess.addTypesIfNotExist();
  Future deleteAllCardTypesByCompany(int id) =>
      typeaccess.deleteAllCardTypesByCompany(id);
